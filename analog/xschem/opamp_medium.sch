...
N -40 -100 -40 -30 {lab=#net2}
N -110 -30 -40 -30 {lab=#net2}
N -40 -30 50 -30 {lab=#net2}
N -160 0 -150 0 {lab=MINUS}
N 90 0 100 0 {lab=PLUS}
N -110 0 50 0 {lab=VDD}
N 0 -190 0 0 {lab=VDD}
N -30 -190 0 -190 {lab=VDD}
N 50 30 50 80 {lab=#net3}
N -110 30 -110 80 {lab=#net4}
N -70 110 10 110 {lab=#net4}
N -50 60 -50 110 {lab=#net4}
N -110 60 -50 60 {lab=#net4}
...
N -280 -100 -180 -100 {lab=#net1}
N -280 -100 -280 -80 {lab=#net1}
N -300 -50 -300 -20 {lab=VSS}
N -280 150 -280 170 {lab=VSS}
N -300 170 -280 170 {lab=VSS}
N -280 170 -180 170 {lab=VSS}
N -280 -20 -280 -0 {lab=VSS}
N -280 0 -280 150 {lab=VSS}
N -300 -20 -280 -20 {lab=VSS}
N 50 50 190 50 {lab=#net3}
N 190 50 190 110 {lab=#net3}
N 190 -130 190 -80 {lab=#net1}
N -80 -80 190 -80 {lab=#net1}
N -80 -130 -80 -80 {lab=#net1}
N 200 30 230 30 {lab=OUT}
N 140 30 140 50 {lab=#net3}
...
C {symbols/pfet_06v0.sym} -160 -130 0 1 {name=M1
L=1.1u
W=4u
nf=1
m=1
...
C {symbols/pfet_06v0.sym} -60 -130 0 0 {name=M2
L=1.1u
W=8u
nf=1
m=1
...
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k_6p0.sym} -280 -50 0 0 {name=R1
W=1e-6
L=1.1e-5
