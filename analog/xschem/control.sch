...
N 420 600 420 610 {lab=DISABLEn}
N 420 530 420 540 {lab=#net1}
...
N 550 700 550 740 {lab=DISABLEn}
N 420 700 550 700 {lab=DISABLEn}
...
N 140 700 270 700 {lab=DISABLEn}
...
C {lab_pin.sym} 670 180 0 0 {name=p24 sig_type=std_logic lab=VSS}
...
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k_6p0.sym} 370 120 1 0 {name=R14
W=1e-6
L=1e-5
model=ppolyf_u_1k_6p0
spiceprefix=X
